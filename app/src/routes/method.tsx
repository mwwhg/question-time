  ...
  return (
    <>
      ...
      <div className="two-pane">
        ...
        <div className="pane-main method-main">
          <section id="workflow" tabIndex={-1}>
            <h2>How it works</h2>
            <p>{TERMS.writtenQuestion}</p>
            <p>
              A model does one narrow job here. It reads a question and its reply and says whether
              the reply gives what was asked. Everything around that job is ordinary code or people.
            </p>
          </section>
          <PipelineGraph />
          ...
          <section id="example" tabIndex={-1} className="worked-example card">
            ...
            <div className="worked-grid">
              ...
              <div className="worked-col">
                ...
                <div>
                  ...
                  <p>
                    That explanation is our interpretation. Jev returned the numerical reading, not
                    this explanation.
                  </p>
                </div>
              </div>
            ...
            <p>
              ...
              . The numbers above come from the record of that first test, kept in the project
              files, not from the run below.
            </p>
          </section>
          ...
          <section id="run" tabIndex={-1}>
            ...
            <p>
              ...
              each reading and the amount of text the model reported receiving. Cost is an estimate
              using the vendor's listed price. These figures describe the recorded run, not proof of
              accuracy or a completed reading of every record.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              that text, and it hands back numbers. It never writes a sentence. For a question with
              a fixed list of answers, it splits 100 between them, and the largest share is its raw
              choice. The site displays “Unclear” when the model’s confidence falls below 50 in 100.
              For a yes or no question, it gives one number out of 100 for yes. The worked example
              above shows exactly what that looks like.
            </p>
          ...
          <section id="questions" tabIndex={-1}>
            ...
            <p>
              ...
              language model on the same human-reviewed sample. That comparison is not done yet.
          ...
          <section>
            ...
            <ul className="bullets">
              <li>
                Whether a reading counts as "unclear": the pipeline treats the model as not sure
                enough when its top-choice confidence is below 50 in 100. The pipeline decides this
                once. The site never does.
              </li>
              <li>
                The reply's word count, whether it contains a number, and which stock phrases it
                uses. Code also estimates how many separate things the question asks using simple
                text rules. That estimate can miss or miscount parts.
              </li>
              <li>
              ...
              <li>
                ...
                since the same question is often sent to many ministers. The distinct-question view
                uses the reading of the lowest-numbered record for each wording. It does not combine
                the replies or their judgements.
              </li>
              <li>
          ...
          <section id="checks" tabIndex={-1}>
            ...
            <p>{TERMS.controls}</p>
            <p>
              We built two kinds. A "swapped" pair keeps the question and puts a reply from a
              completely different portfolio underneath it. A reader paying attention calls that not
              answered. An "echo" pair replies to the question by repeating it back, which also
              answers nothing.
            </p>
            <p>
              Two methods were tested on them. The phrase rules look for set forms of words in the
              reply and nothing else. Jev reads the question and the reply together. "Swapped at
              0.8+" counts the swapped pairs a method called not answered while giving that answer
              at least 80 of its 100 shares.
            </p>
            ...
            <p>
              The phrase rules got 2 of 10 swapped pairs and 0 of 10 echo pairs. An echo reply uses
              only the question's own words and contains no stock phrase, so the rules find nothing
              to match. Jev got 10 of 10 on both. These are twenty pairs we built ourselves. They
              show the rules cannot tell what a reply is about. They do not show how often Jev is
              right on real replies.
            </p>
          ...
          <section id="validation" tabIndex={-1} className="cream-section">
            ...
            <ul className="bullets">
              {NOT_DONE_YET.filter(
                (item) => !checkedAgainstPeople || item.id !== "human-check",
              ).map((item) => (
